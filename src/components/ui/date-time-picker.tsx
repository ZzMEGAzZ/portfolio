...
function DateField(props: AriaDatePickerProps<DateValue>) {
  ...
  return (
    <div
      ...
      ref={ref}
      className={cn(
        'inline-flex flex-1 items-center rounded-l-md border-input bg-transparent px-3 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2',
